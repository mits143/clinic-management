...
public data class MyResultFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): MyResultFragmentArgs {
      bundle.setClassLoader(MyResultFragmentArgs::class.java.classLoader)
      ...
      return MyResultFragmentArgs(__currentItem)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): MyResultFragmentArgs {
      val __currentItem : Int?
