...
class MedicineFragment : BaseFragment<FragmentMedicineBinding>(), MainAdapter.OnClick {
    ...
    private fun setDoctorDummyData(list: ArrayList<String>) {
        val adapter = MainAdapter(arrayListOf(), "Medicine", this)
    ...
    override fun itemClick() {
        findNavController().navigate(R.id.action_nav_medicine_detail)
    }
}